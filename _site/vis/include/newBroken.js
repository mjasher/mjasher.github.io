...
//        });
    ...
    onBeforeEventsLoad: function(){
         ...
         console.log("view", {start :this.options.position.start,
                                        end : this.options.position.end })  
...
var includeCalendar = $('#calendar').calendar(options);

$('.btn-group button[data-calendar-nav]').each(function () {
    var $this = $(this);
    $this.click(function () {
        includeCalendar.navigate($this.data('calendar-nav'));
    });
});
...
$('.btn-group button[data-calendar-view]').each(function () {
    var $this = $(this);
    $this.click(function () {
        includeCalendar.view($this.data('calendar-view'));
    });
});
...
var DisplayView = Backbone.View.extend({
    ...
    filterEvents: function(){
        ...
        //console.log("filter",start,end,unfilteredEvents, events);
...
//        this.model.get('geoBounds')
    ...
    render: function(){
        var filteredEvents = testEvents; //this.filterEvents();
        
        //$('#calendar').empty();  
        //options.events_source = filteredEvents;
        
        //console.log("EVNETS OUSRCHE", options.events_source);
        console.log(options);
        //includeCalendar = $('#calendar').calendar(options);
